...
export CXXFLAGS="--gcc-toolchain=$RR_ENV_ROOT/prefix/usr -isystem $RR_ENV_ROOT/prefix/usr/include"
export CFLAGS="--gcc-toolchain=$RR_ENV_ROOT/prefix/usr -isystem $RR_ENV_ROOT/prefix/usr/include"
